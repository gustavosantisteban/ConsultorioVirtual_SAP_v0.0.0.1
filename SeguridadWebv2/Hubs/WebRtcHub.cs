...
namespace VideoChat.Hubs
{
    ...
    {
        private static readonly List<UsuarioVideoConferencia> Users = new List<UsuarioVideoConferencia>();
        ...
        {
            // Add the new user
            Users.Add(new UsuarioVideoConferencia
            {
                Username = username,
        ...
        public void CallUser(string targetConnectionId)
        {
            ...
            // Create an offer
            CallOffers.Add(new VideoConferenciaRTC
            {
                Caller = callingUser,
                Callee = targetUser
            });
        ...
        public void AnswerCall(bool acceptCall, string targetConnectionId)
        {
            ...
            UserCalls.Add(new UsuariosConectadosVideo
            {
                Users = new List<UsuarioVideoConferencia> { callingUser, targetUser }
            });
        ...
        private UsuariosConectadosVideo GetUserCall(string connectionId)
        {
            var matchingCall =
