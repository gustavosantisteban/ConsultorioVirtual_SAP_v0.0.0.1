...
namespace SeguridadWebv2.Models
{
    ...
    public class RegistrarseEspViewModel
    {
        [Required]
        [Display(Name = "Nombre")]
        public string Nombre { get; set; }
        ...
        [Display(Name = "Telefono asociado")]
        public string Telefono { get; set; }
        
        [Required]
        [Display(Name = "Agregar Especialidad")]
        public string IdEspecialidad { get; set; }

        [Required]
        [Display(Name = "Número de Matrícula")]
        [StringLength(10, ErrorMessage = "La {0} deberia tener al menos {2} caracteres.", MinimumLength = 6)]
